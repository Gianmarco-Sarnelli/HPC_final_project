...
int main(int argc, char **argv) {
    ...
    const int ncols=10;
    float **data;
    char *const fmt="%8.3f ";  // This is the format of the floating point. 8 chars in total (numbers, point and blanks) and 3 numbers in the decimal part
    				// If there are missing chars it will be filled by blanks in the left side of the number
